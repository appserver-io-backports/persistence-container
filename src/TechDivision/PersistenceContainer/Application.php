...
class Application extends AbstractApplication
{
    ...
    public function connect()
    {
        ...
        $this->setDataSourceName($configuration->getChild('/datasource/name')
            ->getValue());
        $this->setPathToEntities($this->getWebappPath() . DIRECTORY_SEPARATOR . $configuration->getChild('/datasource/pathToEntities')
            ->getValue());
     ...
     *
     * @param \TechDivision\ApplicationServer\Configuration $databaseConfiguration
     *            The database configuration
