...
/**
 * TechDivision\PersistenceContainer\StatefulSessionBeanMap
 *
 * NOTICE OF LICENSE
 *
...
use TechDivision\Collections\IndexOutOfBoundsException;
...
class StatefulSessionBeanMap extends GenericStackable implements Map
{
     ...
     *
     * @return \TechDivision\Collections\StatefulSessionBeanMap The instance
     ...
     * @see \TechDivision\Collections\Collection::get($key)
     */
     ...
     * @return void
     * @throws \TechDivision\Collections\InvalidKeyException Is thrown if the passed key is NOT an integer
     * @throws \TechDivision\Collections\NullPointerException Is thrown if the passed key is NULL
     */
