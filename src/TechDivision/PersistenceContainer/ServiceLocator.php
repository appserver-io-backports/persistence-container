...
/**
 * TechDivision\PersistenceContainer\ServiceLocator
 *
 * NOTICE OF LICENSE
 *
...
class ServiceLocator implements ServiceResourceLocator
{
     ...
     * @throws \TechDivision\EnterpriseBeans\EnterpriseBeansException Is thrown if the requested server can't be located
